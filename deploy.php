 ...
 * Deploy
 *
 * @package Pronamic\WordPress\Orbis\Twitter
 */
...
host( 'orbis.pronamic.nl' )
	...
	->set( 'port', 18765 )
	->set( 'deploy_path', '~/projects/wp-orbis-twitter' )
...
task(
	'deploy:update_code',
	function () {
		upload( '{{build_path}}/orbis-twitter/', '{{release_path}}' );
	}
);
